...
(def sepal-length (elt iris 0))
(def sepal-width  (elt iris 1))
(def petal-length  (elt iris 2))
(def petal-width (elt iris 3))
(def iris-vars (list "Sepal Length" "Sepal Width" 
                     "Petal Length" "Petal Width"))
(def iris-data (list sepal-length sepal-width petal-length petal-width))
(def iris (send multi-variable-proto :new iris-data))
(send iris :set-variable-labels iris-vars)
