...
/* external routines */
extern FILE *osaopen();
extern void xlshutdown_hybrid();  /* Voodoo */

/* xmain - the main routine */
xmain(argc,argv)
  int argc; char *argv[];
{
    char *transcript;
...
wrapup()
{
    /* pass last ditch control to user packages */ /* Voodoo */
    xlshutdown_hybrid();
