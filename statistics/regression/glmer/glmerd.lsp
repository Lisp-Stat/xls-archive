From gliu@math.ucla.edu Sat Jan  9 14:06:52 1993
Received: from julia.math.ucla.edu by laplace.sscnet.ucla.edu (4.1/SMI-4.1)
	id AA09074; Sat, 9 Jan 93 14:06:52 PST
Received: from sonia.math.ucla.edu by julia.math.ucla.edu via SMTP 
	(Sendmail 5.61/1.07) id AA07679; Sat, 9 Jan 93 14:07:15 -0800
Return-Path: <gliu@math.ucla.edu>
Received: from oak.math.ucla.edu by sonia.math.ucla.edu via SMTP 
	(Sendmail 5.61/1.07) id AA20503; Sat, 9 Jan 93 14:07:14 -0800
Received: by oak.math.ucla.edu 
	(Sendmail 5.61/1.07) id AA23502; Sat, 9 Jan 93 14:07:11 -0800
Date: Sat, 9 Jan 93 14:07:11 -0800
From: Guanghan Liu <gliu@math.ucla.edu>
Message-Id: <9301092207.AA23502@oak.math.ucla.edu>
To: deleeuw@math.ucla.edu
Subject: GLMERD.lsp
Status: R


This is the glmerd.lsp.

---------CUT HERE-------------
(defun glmerd (Y X U qv link invlink d-link &key (print t) (restrict nil)
...
;; Define functions.
     (labels( 
	     ...
	     (est-b (sigx sigu)
	      ...
	      ;; Calculate vector v for estimating variances. 
	      (est-v (sigx invD)
			 (if restrict
	      ...
	      ;; Estimate variances of random effects. 
	      (update-sigu (b v)
	 ...
	 (format t "~%++++++ Iteration exceeds limit ~3d ++++++~%" count-limit))
			 (if print
         (format t "Iteration= ~2d  Deviance=~g Relative error= ~g~%" 
                count new rel-err)
			))
