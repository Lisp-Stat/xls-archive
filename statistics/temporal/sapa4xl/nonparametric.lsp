...
#+XLISP (require "sapa-package")
#+XLISP (require "utilities")
#+XLISP (require "basic-math")
#+XLISP (require "basic-statistics")
#+XLISP (require "dft-and-fft")
#+XLISP (require "tapers")
#+XLISP (require "filtering")
#+XLISP (require "random")
#+XLISP (require "acvs")
  ...
  (let* ((N-freqs (get-N-freqs N-nonzero-freqs sample-size t))
    ...
    (if data-taper
      (funcall data-taper (make-array
                           sample-size
			   #+XLISP :initial-element #+XLISP 0
                           #-XLISP :displaced-to #-XLISP scratch-dft)
