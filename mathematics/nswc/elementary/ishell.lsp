(defun ishell (a n) (declare (type (simple-array fixnum (*)) a))
 (declare (type fixnum n))
 (prog
  ((k (make-array '(10) :element-type 'fixnum)) (s 0) (ll 0) (l 0) (j 0)
   (jmax 0) (ki 0) (ii 0) (i 0) (imax 0)
  )
  (declare (type (simple-array fixnum (*)) k)) (declare (type fixnum s))
