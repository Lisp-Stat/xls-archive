(defun ai (x) (declare (type double-float x))
 (prog
  ((ai 0.0d0) (c 0.0d0) (n2 0) (n 0) (rd5 0.0d0) (rn4 0.0d0) (qd5 0.0d0)
   (qn5 0.0d0) (pd5 0.0d0) (pn4 0.0d0) (w 0.0d0) (t_ 0.0d0) (rtx 0.0d0)
   (bd5 0.0d0) (bn7 0.0d0) (ad3 0.0d0) (an9 0.0d0) (r 0.0d0)
  )
  (declare (type real ai)) (declare (type double-float c))
  (declare (type fixnum n2)) (declare (type fixnum n))
  ...
  (setq x0 1.587401) (setq c 1.947734) (setq an9 7.890029E-6)
  (setq an8 (- 2.7016547E-5)) (setq an7 (- 1.17114825E-4))
  (setq an6 0.0011417604) (setq an5 (- 0.0020564862))
  (setq an4 (- 0.009670177)) (setq an3 0.049195256) (setq an2 (- 0.038373597))
  (setq an1 (- 0.18739492)) (setq an0 0.35502806) (setq ad3 2.3088744E-5)
  (setq ad2 0.038576253) (setq ad1 0.20117985) (setq ad0 1.0)
  (setq bn7 (- 2.5776693E-5)) (setq bn6 3.5051862E-4)
  ...
  (setf ai (* r (sin phi))) (go end_label) label10 (if (>= x 0.0) (go label20))
  (setf ai
   (/
    (+
     (*
  ...
  (setf ai (* (/ w (sqrt rtx)) (exp (/ (* (* (* -1 2.0) x) rtx) 3.0))))
  (go end_label) label40 (if (> x 4.0d0) (go label50))
  (setf t_ (/ 16.0 (* x rtx)))
  (setf w
   (/
  ...
  (setf ai (* (/ w (sqrt rtx)) (exp (/ (* (* (* -1 2.0) x) rtx) 3.0))))
  (go end_label) label50 (if (> (* x rtx) (* 1.5 (exparg 0))) (go label60))
  (setf t_ (/ 16.0 (* x rtx)))
  (setf w
  ...
  (setf n rtx) (setf n2 (* n n)) (setf t_ (/ (+ x (- n2)) (+ rtx n)))
  (setf ai
   (* (/ (/ w (sqrt rtx)) (expt c (* n2 n)))
    (exp (* (* (* -1 2.0) t_) (+ (* n rtx) (/ (* t_ t_) 3.0))))
  ))
  (go end_label) label60 (setf ai 0.0) (go end_label) end_label (return ai)
))
